...
int initgame(char *missionfilename, int actorID, int hosting);
...
ACTOR *spawnactor_player(int type, int x, int y, int angle, int actorID);
ACTOR *spawnactor_internal(int type, int x, int y, int angle, int actorID);
